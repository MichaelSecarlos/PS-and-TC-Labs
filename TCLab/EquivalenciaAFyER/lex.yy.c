...
static const flex_int16_t yy_base[17] =
    {   0,
        0,    0,   19,   20,   13,    8,   12,   11,    0,    0,
        9,    5,    4,   20,   20,    9
    } ;

static const flex_int16_t yy_def[17] =
    {   0,
       15,    1,   15,   15,   16,   16,   16,    6,    6,    7,
       15,   15,   15,   15,    0,   15
    } ;

static const flex_int16_t yy_nxt[30] =
    {   0,
        4,    5,    5,    6,    7,    6,    8,    6,    6,   11,
        9,   14,   15,   13,   12,   10,   15,   10,   15,    3,
...
YY_RULE_SETUP
#line 4 "ejercicio3.l"
{printf("Se ha detectado una url que termina en .com\n");}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 5 "ejercicio3.l"
